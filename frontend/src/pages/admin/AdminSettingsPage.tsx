    ...
    <AdminLayout>
      <header className="relative mb-6 overflow-hidden rounded-3xl border border-gray-200 bg-gray-50/40 px-5 py-5 shadow-[0_18px_48px_rgba(0,0,0,0.4)] backdrop-blur-3xl sm:px-7 xl:px-8 xl:py-7">
        ...
        <div className="relative">
          ...
          <p className="mt-4 text-[clamp(1rem,1.25vw,1.25rem)] leading-7 font-bold text-slate-600">Tweak global constants for the AI models and system thresholds.</p>
        </div>
      </header>
      ...
      {settings && (
        <div className="space-y-6">
          <section className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50/40 p-6 shadow-[0_18px_46px_rgba(0,0,0,0.3)] backdrop-blur-2xl">
            <h2 className="mb-4 text-lg font-extrabold text-gray-900">Simulation Thresholds</h2>
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <label className="mb-1.5 block text-xs font-extrabold uppercase tracking-wider text-slate-500">Global Max Basal Rate (U/h)</label>
              ...
              <div>
                <label className="mb-1.5 block text-xs font-extrabold uppercase tracking-wider text-slate-500">Advanced What-If Scenarios</label>
                ...
                <label className="flex h-[46px] cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4">
                  ...
                  />
                  <span className="text-sm font-bold text-gray-900">Enable Advanced Mode</span>
                </label>
              </div>
            </div>
          </section>
          ...
          <section className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50/40 p-6 shadow-[0_18px_46px_rgba(0,0,0,0.3)] backdrop-blur-2xl">
            <h2 className="mb-4 text-lg font-extrabold text-gray-900">Default Patient Targets</h2>
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <label className="mb-1.5 block text-xs font-extrabold uppercase tracking-wider text-slate-500">Default Target Min (mg/dL)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="mb-1.5 block text-xs font-extrabold uppercase tracking-wider text-slate-500">Default Target Max (mg/dL)</label>
                <input
                  type="number"
